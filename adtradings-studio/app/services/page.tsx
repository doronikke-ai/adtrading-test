            ...
            {services.map((service, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="font-mono text-2xl font-semibold text-accent transition-colors duration-300 group-hover:text-highlight group-focus-visible:text-highlight">{String(i + 1).padStart(2, '0')}</span>
                  <div>
                    <h2 className="text-balance text-2xl font-semibold tracking-tight text-foreground transition-colors duration-300 group-hover:text-primary-foreground group-focus-visible:text-primary-foreground md:text-3xl">{serviceTitle}</h2>
