...
type Dictionary = {
  ...
  contact: {
    ...
    infoTitle: string
    formTitle: string
    details: { office: string; phone: string; email: string; response: string; welcome: string }
...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    contact: {
      ...
      details: { office: 'Office', phone: 'Phone', email: 'Email', response: 'Response', welcome: 'Wholesale & consumer retail — everyone welcome.' },
      form: {
...
infoTitle: '直接联系我们',
  formTitle: '发送消息',
  details: { office: '办公室', phone: '电话', email: '邮箱', response: '回复时间', welcome: '批发与零售客户均欢迎。' },
  form: {
  ...
  th: {
    ...
    services: {
      ...
      items: [
        ...
        { title: 'จัดส่งท้องถิ่นในแวนคูเวอร์', short: 'จัดส่งเชิงพาณิชย์ทั่วเขตเม�����ทรแวนคูเวอร์ ตั้งแต่อาหารแช่แข็งถึงสินค้าขนาดใหญ่', long: 'บริการจัดส่งเชิงพาณิชย์ทั่วเขตเมโทรแวนคูเวอร์ ตั้งแต่อาหารแช่แข็งที่ควบคุมอุณหภูมิไปจนถึงสินค้าขนาดใหญ่ โดยทีมเดียวดูแลตั้งแต่ท่าเรือถึงหน้าประตู' },
      ],
    },
    products: {
      hero: {
    ...
    about: {
      ...
      story: {
        ...
        body: [
          'Asia Direct Tradings LTD. ก่อตั้งขึ้นเพื่อลดช่องว่างระหว่างสิ่งที่ผู้ซื้อในอเมริกาเหนือได้รับการสัญญาไว้กับสิ่งที่���ด้รับจริง ทั้งในด้านสภาพสินค้า มาตรฐาน และเวลา',
...
infoTitle: 'ติดต่อเราโดยตรง',
  ...
  details: { office: 'สำนักงาน', phone: 'โทรศัพท์', email: 'อีเมล', response: 'การตอบกลับ', welcome: 'ยินดีต้อนรับทั้งลูกค้าขายส่งและค้าปลีก' },
  form: {
...
dictionaries.tc = {
  ...
  services: { ...dictionaries.zh.services, hero: { kicker: '服務', title: '五種貨物流通方式', subtitle: '從批發供應到反向出口，每一項服務都由同一團隊負責——代理駐紮亞洲各地，溫哥華本地團隊隨時支援。' }, learnMore: '了解更多', items: [{ title: 'B2B 批發供應', short: '精選高端亞洲乾貨，進口即可銷售。', long: '精選高端亞洲乾貨與特色食品，���口即可上架，並以批發價格提供。每項產品均由品類專家挑選，完成清關並符合 CFIA 與 FDA 標籤標準。' }, { title: '採購服務', short: '告訴我們您要銷售的產品，我們負責尋找、核實並運達。', long: '告訴我們產品與市場需求。我們在亞洲各地的代理會尋找合適供應商、���自考察、協商條款，並管理運輸、清關與合規，讓您收到完全符合核准規格的產品。' }, { title: '協助亞洲品牌拓展市場', short: '為尚未需要設立辦公室的品牌提供加拿大團隊。', long: '對準備進入北美、但尚未需要自設辦公室的亞洲品牌，我們可作為您的加拿大團隊，負責進口、合規標籤、倉儲、分銷與買家關係。' }, { title: '反向出口至亞洲', short: '將加拿大商品出口給亞洲各地買家。', long: '貿易路線雙向運行。我��將加拿大產品出口給亞洲各地經審核的買家，並由同一團隊管理文件、運輸與目的地合規。' }, { title: '溫哥華本地配送', short: '覆蓋大溫地區，從冷凍食品到大型貨運。', long: '提供大溫哥華地區的商業配送，從冷凍食品到大型貨運皆可處理。最後一公里由我們的團隊負責，讓貨物從港口到門口始終由同一團隊跟進。' }] },
  products: { ...dictionaries.zh.products, hero: { kicker: '產品', title: '我們的產品', subtitle: '由品類專家精選的高端亞洲乾貨與特色食品，進口即可上架，價格適合批發。' }, categories: [{ title: '乾海產品', body: '由品類專家精選的高端乾海產品，完成清關並符合 CFIA �� FDA 標籤標準。' }, { title: '特色零食', body: '具備市場需求的地區零食品牌，進口後以批發價格供北美分銷。' }, { title: '日常食材', body: '醬料、乾貨與日常食材，直接採購自亞洲經審核的製造商。' }, { title: '季節及特色商品', body: '限量及季節性商品，可透過我們駐紮亞洲各���的���理按需採購。' }], cta: { title: '正在尋找特定產品？', body: '即使目錄中暫未列出，我們的採購團隊大多也能找到。', button: '聯絡我們的採購團隊' } },
  ...
  about: { ...dictionaries.zh.about, hero: { kicker: '關於我們', title: '以實地存在，而非紙面承諾，建立的貿易商行。', subtitle: 'Asia Direct Tradings LTD. 是一家總部位於溫哥華的貿易商行，連接亞洲供應商與北美買家。' }, story: { kicker: '我們的故事', title: '由希望把貿易做得踏實的人創辦。', body: ['Asia Direct Tradings LTD. 的成立，正是為了彌合北美買家所被承諾的與實際到貨之間的差距——無論是貨物狀態、合規性還是時效。', '我們沒有選擇遠程中介，而是將自己的代理派駐亞洲各地，直接考察供應商、協商條款，並全程管理從原產地到目的地的運輸。', '如今，同一團隊負責批發供應、貨源採購、協助亞洲品牌進入市場、對亞洲的反向出口，以及大溫哥華地區的最後一公里配送。'] }, process: { kicker: '合作方式', title: '三個步驟，一個團隊全程負責。', steps: [{ n: '01', title: '確認需求', body: '在啟動任何貨物之前，我們先確認產品、目標市場與合規要求。' }, { n: '02', title: '採購與核實', body: '當地代理實地考察供應商、協商條款，並親自確認產品品質。' }, { n: '03', title: '交付與支援', body: '運輸、清關與最後一公里配送均由同一團隊全程負責。' }] } },
  contact: { ...dictionaries.zh.contact, hero: { kicker: '聯絡我們', title: '讓我們談談貿易。', subtitle: '告訴我們您需要採購、銷售或運輸的產品——我們的團隊將在一個工作日內給出方案。' }, infoTitle: '直接聯絡我們', formTitle: '發送訊息', details: { office: '辦公室', phone: '電話', email: '電子郵件', response: '回覆時間', welcome: '批發與零售客戶均歡迎。' }, form: { phone: '電話', inquiryType: '詢問類型', selectService: '選擇服務', serviceValues: ['B2B 批發供應', '採購服務', '協助亞洲品牌拓展市場', '反向出口至亞洲', '溫哥華本地配送'], name: '姓名', email: '電子郵件', company: '公司', message: '留言', submit: '發送訊息', submitting: '發送中…', success: '感謝您的留言，我們已收到並將盡快與您聯絡。', error: '出現問題，請重試或直接寄送電子郵件給我們。' } },
...
dictionaries.ja = {
  ...
  contact: { ...dictionaries.en.contact, hero: { kicker: 'お問い合わせ', title: '貿易についてお話ししましょう。', subtitle: '調達、販売、輸送したい商品をお聞かせください。1営業日以内にご提案します。' }, infoTitle: '直接お問い合わせ', formTitle: 'メッセージを送る', details: { office: 'オフィス', phone: '電話', email: 'メール', response: '返信', welcome: '卸売・小売のお客様を歓迎します。' }, form: { phone: '電話', inquiryType: 'お問い合わせ内容', selectService: 'サービスを選択', serviceValues: ['B2B卸売供給', '商品調達サービス', 'アジアブランドの北米進出', 'アジアへの逆輸出', 'バンクーバー地域配送'], name: 'お名前', email: 'メールアドレス', company: '会社名', message: 'メッセージ', submit: '送信する', submitting: '送信中…', success: 'お問い合わせありがとうございます。確認後、担当者よりご連絡します。', error: '問題が発生しました。もう一度お試しいただくか、直接メールでお問い合わせください。' } },
  footer: { ...dictionaries.en.footer, tagline: '上質なアジ��商品を一貫して調達。卸売供給、商品調達、市場参入、アジアへの逆輸出、バンクーバー地域配送まで、アジア各地のスタッフが対応します。', explore: 'メニュー', contact: 'お問い合わせ', strapline: '上質なアジア商品を一貫して調達 — 食品・スナック・日用���。' },
}
