  ...
  th: {
    ...
    home: {
      ...
      network: {
        ...
        title: 'ตัวแทน���ระจำทั่วเอเชีย ส่งตรงถึงอเมริกาเหนือ',
      },
      whyUs: {
    ...
    products: {
      hero: {
        ...
        subtitle:
          'แคตตาล็อกสินค้าอาหารแห้งและอาหารพิเ���ษเอเชียคุณภาพสูงที่คัดสรรมาอย่างดี พร้อมนำเข้าและตั้งราคาสำหรับการขายส่ง',
      },
      categories: [
        {
          title: 'อาหารทะเลแห้ง',
...
dictionaries.tc = {
  ...
  products: { ...dictionaries.zh.products, hero: { kicker: '產品', title: '我們的產品', subtitle: '由品類專家精選的高端亞洲乾貨與特色食品，進口即可上架，價格適合批發。' }, categories: [{ title: '乾海產品', body: '由品類專家精選的高端乾海產品，完成清關並符合 CFIA 與 FDA 標籤標準。' }, { title: '特色零食', body: '具備市場需求的地區零食品牌，進口後以批發價格供北美分銷。' }, { title: '日常食材', body: '醬料、乾貨與日常食材，直接採購自亞洲經審核的製造商。' }, { title: '季節及特色商品', body: '限量及季節性商品，可透過我們駐紮亞洲各地的���理按需採購。' }], cta: { title: '正在尋找特定產品？', body: '即使目錄中暫未列出，我們的採購團隊大多也能找到。', button: '聯絡我們的採購團隊' } },
