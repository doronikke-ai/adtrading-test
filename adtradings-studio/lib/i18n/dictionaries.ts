...
dictionaries.tc = {
  ...
  home: {
    ...
    whyUs: { kicker: '為何選擇 Asia Direct', title: '一個團隊，從工廠到您的門口。', items: [{ n: '01', title: '實地把關', body: '我們的代理親赴亞洲各地實地考察供應商——不是只傳遞二手資訊的中間商。' }, { n: '02', title: '合規先行', body: '海關、CFIA 與 FDA 標籤合規工作，在貨物抵達您的倉庫之前已全部處理妥當。' }, { n: '03', title: '一個團隊，雙向貿易', body: '同一團隊同時負責進口貨源與對亞洲的反向出口，避免在兩個供應商之間出現脫節。' }] },
